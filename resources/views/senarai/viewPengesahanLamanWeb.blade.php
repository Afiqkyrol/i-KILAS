...
<center><h2><b>PENGESAHAN BORANG PERMOHONAN KEMASKINI LAMAN WEB</b></h2></center>
    ...
    <form style="padding-left:250px" method="POST" action="{{route('tindakan.PengesahanLamanWeb')}}">
        @csrf
