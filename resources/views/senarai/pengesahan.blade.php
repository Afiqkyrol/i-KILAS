...
<br><center><h2><b>SENARAI PERMOHONAN UNTUK DISAHKAN</b></h2></center><br>
...
<table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('senarai.viewPengesahanLamanWeb',['id'=> $data -> id])}}" class="btn btn-primary btn-sm">Tindakan</a></td>
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('senarai.viewPengesahanAduan',['id'=> $data2 -> id])}}" class="btn btn-primary btn-sm">Tindakan</a></td>
                            ...
                            <td colspan="6"><center>Tiada Permohonan Yang Perlu Disah</center></td>
