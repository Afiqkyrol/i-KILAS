...
<a style="padding-left:25px; padding-right:25px;" href="{{route('senarai.semakan')}}" class="btn btn-primary btn-sm">Kembali</a>
</div>

<br>

<center><h2><b>SEMAKAN BORANG PERMOHONAN KEMASKINI LAMAN WEB</b></h2></center>
    ...
    <form style="padding-left:250px" method="POST" action="{{ route('tindakan.SemakanLamanWeb') }}">
        @csrf
        <label><h4><b>ULASAN PENYELIA: </b>(optional)</h4></label><br>
        <div><textarea style="width:650px; height:150px;" type="text" name="ulasan_penyelia"
        ></textarea></div><br>

        <br>

        <label style="color:red"><h4><b>TINDAKAN:</b></h4></label>
        <select style="width:35%" class="form-control select2" name="semakan">
