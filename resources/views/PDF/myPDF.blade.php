        ...
        <div>
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td colspan="3" style="width:70%; padding-top:0px;">:-{{$permohonan->zipdoc}}</td>
                </tr>
                <tr>
                    <th style="width:30%">Dokumen 2</th>
                    <td colspan="3" style="width:70%; padding-top:0px;">:-{{$permohonan->zipdoc2}}</td>
                </tr>
                <tr>
                    <th style="width:30%">Dokumen 3</th>
                    <td colspan="3" style="width:70%; padding-top:0px;">:-{{$permohonan->zipdoc3}}</td>
                </tr>
                <tr>
                    <th style="width:30%">Dokumen 4</th>
                    <td colspan="3" style="width:70%; padding-top:0px;">:-{{$permohonan->zipdoc4}}</td>
                </tr>
                <tr>
                    <th style="width:30%">Dokumen 5</th>
                    <td colspan="3" style="width:70%; padding-top:0px;">:-{{$permohonan->zipdoc5}}</td>
                </tr>
                <tr>
                    <th style="width:30%">Dokumen 6</th>
                    <td colspan="3" style="width:70%; padding-top:0px;">:-{{$permohonan->zipdoc6}}</td>
                </tr>
            </table>
        </div>
    @php }else{ @endphp
